...
void wifiConnect()
{
  ...
  WiFi.mode(WIFI_STA);
  //WiFiMulti.addAP("SSID", "PASSWORD");  // I don't need SSID/pwd to connect?!?!?
  //WiFiMulti.addAP("PLUSNET-8FXFF7", "6f7cc3ee6f");
  WiFiMulti.addAP("BTHub6-F6WM", "7HtpWv3Yx9eN");
